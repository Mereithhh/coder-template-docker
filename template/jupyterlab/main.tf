...
variable "docker_image" {
  ...
  default = "registry.cn-beijing.aliyuncs.com/mereith/coder-python"
  validation {
    condition = contains(["registry.cn-beijing.aliyuncs.com/mereith/coder-base", "registry.cn-beijing.aliyuncs.com/mereith/coder-python"], var.docker_image)
